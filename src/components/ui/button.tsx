  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium transition-all duration-300 ease-out disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*=\'size-\'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        glass:
          "relative overflow-hidden bg-white/20 backdrop-blur-lg border border-white/30 text-foreground shadow-xs hover:shadow-lg hover:shadow-primary/20 active:scale-95 dark:bg-black/20 dark:border-black/30 before:content-[''] before:absolute before:inset-0 before:bg-white/30 dark:before:bg-black/30 before:scale-x-0 before:origin-left before:transition-transform before:duration-300 before:ease-in-out hover:before:scale-x-100 [&>*]:relative [&>*]:z-10",
      },
      size: {
