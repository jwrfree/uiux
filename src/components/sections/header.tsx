          ...
          <div
            ...
            <div className="flex justify-start items-center">
              <Link
                ...
                <span className="text-2xl md:text-3xl font-medium bg-gradient-to-b from-[#232522] to-[rgba(35,37,34,0.4)] text-transparent bg-clip-text !whitespace-pre-line !whitespace-pre-line">wruhantojatiJATI
