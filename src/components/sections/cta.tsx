  ...
  return (
    <section className="relative overflow-hidden bg-background py-20 sm:py-24 md:py-40 lg:py-48">
      ...
      <div className="container relative z-10 mx-auto flex flex-col items-center text-center">
        <h2 className="max-w-5xl font-display text-4xl font-medium leading-tight bg-gradient-to-b from-[var(--color-gradient-text-start)] to-[var(--color-gradient-text-end)] bg-clip-text text-transparent md:text-5xl lg:text-[56px] lg:leading-[1.1]">
